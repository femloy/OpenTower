function load_level_update(level_name)
{
    var path = working_directory + concat("/levels/", level_name, "/");
    ...
    else if save_step < array_length(load_array)
    {
        ...
        for (var i = 0; i < array_length(_room.backgrounds); i++)
        {
            ...
            bg.layer_type = editor_layer_types.background;
