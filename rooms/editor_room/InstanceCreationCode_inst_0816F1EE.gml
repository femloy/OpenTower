...
array_sort(_categories, function(e1, e2)
{
    return ds_map_find_value(obj_editor.object_order_map, e1) - ds_map_find_value(obj_editor.object_order_map, e2);
});

for (i = 0; i < array_length(_categories); i++)
{
    var b = _categories[i];
...
with instance_create_depth(32, 0, depth - 1, obj_itemlist)
{
    ...
    {       
        ...
        {
            var item = ds_list_find_value(items, pos);
